...
//                            offset: Offset(0, 3), // changes position of shadow
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                GestureDetector(
                                    child: Text("Quên mật khẩu", style: TextStyle(color: colors),),
                                    behavior: HitTestBehavior.translucent,
                                  onTap: ()=>  Get.toNamed(ForgotPasswordUI.routName),
                                ),
                                Padding(
                                ...
                                GestureDetector(
                                    onTap: ()=> Get.toNamed(RegisterUI.routName),
                                    behavior: HitTestBehavior.translucent,
                                    child: Text("Tạo tài khoản",style: TextStyle(color: colors, fontSize: SizeManager().size_header_4),))
                              ],
                            ),
                          )
                        ],
